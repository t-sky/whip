...
var len__5726__auto___15994 = arguments.length;
var i__5727__auto___15995 = (0);
while(true){
if((i__5727__auto___15995 < len__5726__auto___15994)){
args__5733__auto__.push((arguments[i__5727__auto___15995]));

var G__15996 = (i__5727__auto___15995 + (1));
i__5727__auto___15995 = G__15996;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq15993){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15993));
});
/**
...
var vec__15998 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15998,(0),null);
var words = cljs.core.nthnext(vec__15998,(1));
...
var G__16000 = clojure.set.rename_keys(m,kmap);
var G__16000__$1 = ((cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__16000,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys):G__16000);
return G__16000__$1;
} else {
return m;
}
...
var args__5733__auto__ = [];
var len__5726__auto___16003 = arguments.length;
var i__5727__auto___16004 = (0);
while(true){
if((i__5727__auto___16004 < len__5726__auto___16003)){
args__5733__auto__.push((arguments[i__5727__auto___16004]));

var G__16005 = (i__5727__auto___16004 + (1));
i__5727__auto___16004 = G__16005;
continue;
} else {
}
break;
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__16001_SHARP_){
if(cljs.core.list_QMARK_(p1__16001_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16001_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__16001_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq16002){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16002));
});
/**
...
var vec__16009 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16009,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16009,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__16009,tag_name,names){
return (function (p1__16006_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__16006_SHARP_));
});})(matches,vec__16009,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__16009,tag_name,names){
return (function (p1__16007_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__16007_SHARP_));
});})(matches,vec__16009,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__16010){
var vec__16013 = p__16010;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16013,(0),null);
var content = cljs.core.nthnext(vec__16013,(1));
...
var vec__16014 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16014,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16014,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16014,(2),null);
