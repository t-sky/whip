...
var G__20892 = res;
var G__20893 = (function (){var G__20894 = ((function (G__20892,parser,c){
return (function (t){
...
;
var G__20895 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__20894,G__20895) : parser.call(null,G__20894,G__20895));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__20892,G__20893) : then.call(null,G__20892,G__20893));
});
;})(parser,c))
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5284__auto__,k20897,else__5285__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k20897,else__5285__auto__);
...
var res = (function (){var G__20900 = cljs.core.PersistentVector.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__20900) : cljs.core.atom.call(null,G__20900));
})();
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20896){
var self__ = this;
var G__20896__$1 = this;
return (new cljs.core.RecordIter((0),G__20896__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre,cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], null),cljs.core._iterator(self__.__extmap)));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5289__auto__,k__5290__auto__,G__20896){
var self__ = this;
var this__5289__auto____$1 = this;
var pred__20901 = cljs.core.keyword_identical_QMARK_;
var expr__20902 = k__5290__auto__;
if(cljs.core.truth_((pred__20901.cljs$core$IFn$_invoke$arity$2 ? pred__20901.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pre,expr__20902) : pred__20901.call(null,cljs.core.cst$kw$pre,expr__20902)))){
return (new schema.spec.collection.CollectionSpec(G__20896,self__.constructor,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__20901.cljs$core$IFn$_invoke$arity$2 ? pred__20901.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$constructor,expr__20902) : pred__20901.call(null,cljs.core.cst$kw$constructor,expr__20902)))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__20896,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__20901.cljs$core$IFn$_invoke$arity$2 ? pred__20901.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$elements,expr__20902) : pred__20901.call(null,cljs.core.cst$kw$elements,expr__20902)))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,G__20896,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__20901.cljs$core$IFn$_invoke$arity$2 ? pred__20901.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$on_DASH_error,expr__20902) : pred__20901.call(null,cljs.core.cst$kw$on_DASH_error,expr__20902)))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,self__.elements,G__20896,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5290__auto__,G__20896),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5281__auto__,G__20896){
var self__ = this;
var this__5281__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor,self__.elements,self__.on_error,G__20896,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__20898){
return (new schema.spec.collection.CollectionSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__20898),cljs.core.cst$kw$constructor.cljs$core$IFn$_invoke$arity$1(G__20898),cljs.core.cst$kw$elements.cljs$core$IFn$_invoke$arity$1(G__20898),cljs.core.cst$kw$on_DASH_error.cljs$core$IFn$_invoke$arity$1(G__20898),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__20898,cljs.core.cst$kw$pre,cljs.core.array_seq([cljs.core.cst$kw$constructor,cljs.core.cst$kw$elements,cljs.core.cst$kw$on_DASH_error], 0)),null));
});
...
var seq__20909_20913 = cljs.core.seq(coll);
var chunk__20910_20914 = null;
var count__20911_20915 = (0);
var i__20912_20916 = (0);
while(true){
if((i__20912_20916 < count__20911_20915)){
var x_20917 = chunk__20910_20914.cljs$core$IIndexed$_nth$arity$2(null,i__20912_20916);
(item_fn.cljs$core$IFn$_invoke$arity$1 ? item_fn.cljs$core$IFn$_invoke$arity$1(x_20917) : item_fn.call(null,x_20917));
...
var temp__4425__auto___20922 = cljs.core.seq(seq__20909_20913);
if(temp__4425__auto___20922){
var seq__20909_20923__$1 = temp__4425__auto___20922;
if(cljs.core.chunked_seq_QMARK_(seq__20909_20923__$1)){
var c__5471__auto___20924 = cljs.core.chunk_first(seq__20909_20923__$1);
var G__20925 = cljs.core.chunk_rest(seq__20909_20923__$1);
var G__20926 = c__5471__auto___20924;
var G__20927 = cljs.core.count(c__5471__auto___20924);
var G__20928 = (0);
...
var x_20929 = cljs.core.first(seq__20909_20923__$1);
(item_fn.cljs$core$IFn$_invoke$arity$1 ? item_fn.cljs$core$IFn$_invoke$arity$1(x_20929) : item_fn.call(null,x_20929));

var G__20930 = cljs.core.next(seq__20909_20923__$1);
var G__20931 = null;
var G__20932 = (0);
var G__20933 = (0);
