...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5284__auto__,k20959,else__5285__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k20959,else__5285__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20958){
var self__ = this;
var G__20958__$1 = this;
return (new cljs.core.RecordIter((0),G__20958__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre], null),cljs.core._iterator(self__.__extmap)));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5289__auto__,k__5290__auto__,G__20958){
var self__ = this;
var this__5289__auto____$1 = this;
var pred__20962 = cljs.core.keyword_identical_QMARK_;
var expr__20963 = k__5290__auto__;
if(cljs.core.truth_((pred__20962.cljs$core$IFn$_invoke$arity$2 ? pred__20962.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pre,expr__20963) : pred__20962.call(null,cljs.core.cst$kw$pre,expr__20963)))){
return (new schema.spec.leaf.LeafSpec(G__20958,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5290__auto__,G__20958),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5281__auto__,G__20958){
var self__ = this;
var this__5281__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__20958,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__20960){
return (new schema.spec.leaf.LeafSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__20960),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__20960,cljs.core.cst$kw$pre),null));
});
